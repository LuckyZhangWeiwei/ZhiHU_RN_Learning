...
DataRepository.prototype._safeStorage = function(key: string) {
    ...
    DataRepository.prototype._safeFetch = function(reqUrl: string) {
        ...
        DataRepository.prototype.getComment=function (storyID: string) {
            return this._safeFetch("http://news-at.zhihu.com/api/4/story/"+storyID+"/short-comments");
            /*var urls=[
                "http://news-at.zhihu.com/api/4/story/"+storyID+"/short-comments",
                "http://news-at.zhihu.com/api/4/story/"+storyID+"/long-comments"
            ];
            var data=[];
            for(var index in urls){
                this._safeFetch(urls[index]).then((responseData)=>{
