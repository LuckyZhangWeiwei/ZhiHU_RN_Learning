...
var MyWebView = (Platform.OS === 'ios') ? WebView : require('./MyWebView');
...
var StoryScreen = React.createClass({
  ...
  onWebViewScroll: function(event) {
    var scrollY = -event.ScrollY / PIXELRATIO;
    this.state.scrollValue.setValue(scrollY);
  },
  render: function() {
    var toolbar = <DetailToolbar navigator={this.props.navigator} style={styles.toolbar} story={this.props.story} isNeedShare="true" isNeedCollect="true" isNeedComment="true" isNeedPraise="true" />;
...
//        var translateY=this.state.scrollValue;
